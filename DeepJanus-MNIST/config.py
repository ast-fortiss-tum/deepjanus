...
TF_KERAS_VIS_TECHNIQUE = "Gradcam++"  # "Faster-ScoreCAM"
...
SEEDS_LIST_FOR_REPETITIONS_OF_MUTATIONS = [4398, 980, 987423, 99982, 1123, 4098, 1946, 22601, 55037, 812109, 53898,
                                           187988]
NORMAL_MUTATION_ADAPTIVE_ENABLED = False
...
NUMBER_OF_DIGIT_SAMPLES = 1  # Number of samples of a same digit that will be mutated in the experiment
N = 10 * NUMBER_OF_DIGIT_SAMPLES  # Number of total Images to take from MNIST dataset
